...
!(function (r, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : "function" == typeof define && define.amd
      ? define(t)
      : ((r = "undefined" != typeof globalThis ? globalThis : r || self).jsSHA =
          t());
})(this, function () {
  "use strict";
  var r = function (t, n) {
      ...
      return (
        (r.prototype.update = function (r) {
          var t,
            n = 0,
            i = this.m >>> 5,
            e = this.h(r, this.H, this.Y),
            o = e.binLen,
            u = e.value,
            s = o >>> 5;
          for (t = 0; t < s; t += i)
            n + this.m <= o &&
              ((this.R = this.p(u.slice(t, t + i), this.R)), (n += this.m));
          return (
            (this.I += n),
            (this.H = u.slice(n >>> 5)),
            (this.Y = o % this.m),
        ...
        (r.prototype.getHash = function (r, t) {
          ...
          for (
            i = this.T(this.H.slice(), this.Y, this.I, this.A(this.R), e),
              n = 1;
            n < this.numRounds;
            n += 1
          )
            (this.g &&
              ...
              (i = this.T(i, e, 0, this.U(this.S), e)));
          return s(i);
        }),
        ...
        (r.prototype.B = function (r) {
          ...
          for (
            n < r.binLen / 8 &&
            (r.value = this.T(r.value, r.binLen, 0, this.U(this.S), this.F));
            r.value.length <= i;
          )
            r.value.push(0);
          for (t = 0; t <= i; t += 1)
          ...
          ((this.R = this.p(this.N, this.R)), (this.I = this.m), (this.L = !0));
        }),
